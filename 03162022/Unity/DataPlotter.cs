...
public class DataPlotter : MonoBehaviour {
    ...
    void Start () {
        ...
        for (var i = 0; i < pointList.Count; i++)
        {
            ...
            string wrd = System.Convert.ToString(pointList[i][myWord]);
            ...
            //TextMeshPro words = GetComponent<TextMeshPro>();
            //words.text = "HELLO";
            //word.text = "HELLO";
            ...
            words = dataPoint.GetComponent<TextMeshPro>();
            words.text = wrd;
            words.color = new Color(x,y,z, 1.0f);
        }       
