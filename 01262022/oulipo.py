...
def printOulipo(nounRestrict,num,corpusLines,dictWordList,indexDictionary,lemmatizer):
	stop_words = set(stopwords.words('english'))
...
def main():
	...
	if(len(sys.argv) == 1):
		...
		try:
			...
			printOulipo(nounRestrict,num,getCorpusLines(sourceFile),dictWordList,indexDictionary,lemmatizer)
